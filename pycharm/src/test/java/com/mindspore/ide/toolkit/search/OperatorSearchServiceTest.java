...
public class OperatorSearchServiceTest {
    ...
    public void testOperatorSearchService() {
        ...
        Assert.assertEquals(370, OperatorSearchService.INSTANCE.search("torch").size());
        Assert.assertEquals(370, OperatorSearchService.INSTANCE.search("TORCH").size());
        Assert.assertEquals(10, OperatorSearchService.INSTANCE.search("torch", 10).size());
        Assert.assertEquals(10, OperatorSearchService.INSTANCE.search("TORCH", 10).size());
        Assert.assertEquals(72, OperatorSearchService.INSTANCE.search("tf").size());
        Assert.assertEquals(72, OperatorSearchService.INSTANCE.search("TF").size());
        ...
        map1.put("tf.metrics.mean_iou -> mindspore.ops.IOU",
                "https://mindspore.cn/docs/api/en/r1.5/api_python/ops/mindspore.ops.IOU.html");
        ...
        map2.put("torch.abs -> mindspore.ops.Abs",
                "https://mindspore.cn/docs/api/en/r1.5/api_python/ops/mindspore.ops.Abs.html#mindspore.ops.Abs");
    ...
    public void testOperatorSearchServiceSpecial() {
        ...
        map1.put("torch.nn.GELU -> mindspore.nn.GELU",
                "https://mindspore.cn/docs/api/en/r1.5/api_python/nn/mindspore.nn.GELU.html#mindspore.nn.GELU");
        map1.put("torch.nn.GELU -> mindspore.nn.FastGelu",
                "https://mindspore.cn/docs/api/en/r1.5/api_python/nn/mindspore.nn.FastGelu.html#mindspore.nn.FastGelu");
        ...
        map2.put("tf.keras.optimizers.Adagrad -> mindspore.nn.Adagrad",
                "https://mindspore.cn/docs/api/en/r1.5/api_python/nn/mindspore.nn.Adagrad.html");
        map2.put("torch.optim.Adagrad -> mindspore.nn.Adagrad",
                "https://mindspore.cn/docs/api/en/r1.5/api_python/nn/mindspore.nn.Adagrad.html#mindspore.nn.Adagrad");
        ...
        "https://www.mindspore.cn/docs/api/en/r1.5/api_python/mindspore/mindspore.Tensor.html#mindspore.Tensor.take");
        map3.put("torch.take -> mindspore.Tensor.take",
        "https://mindspore.cn/docs/api/en/r1.5/api_python/mindspore/mindspore.Tensor.html#mindspore.Tensor.take");
