 ...
 * @since 2022-04-18
 */
public class DemoBrowserWindowContent implements Disposable {
     ...
     * construction method
     */
    public DemoBrowserWindowContent() {
        ...
        if (!JBCefApp.isSupported()) {
            ...
            try (InputStream inputStream = DemoBrowserWindowContent.class.getResourceAsStream("/RecommendDemo.html");
