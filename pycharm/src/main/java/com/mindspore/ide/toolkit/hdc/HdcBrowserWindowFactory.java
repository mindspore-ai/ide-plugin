 ...
 * @since 2022-04-18
 */
public class HdcBrowserWindowFactory implements ToolWindowFactory {
    @Override
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        ContentManager contentManager = toolWindow.getContentManager();
        HdcBrowserWindowContent browserWindow = HdcBrowserWindowManager.getBrowserWindow(project);
        ...
        actionList.add(ActionManager.getInstance().getAction("HDCRefreshAction"));
        ...
        router.addHandler(new HdcMessageRouterHandlerAdapter(project, browserWindow), true);
