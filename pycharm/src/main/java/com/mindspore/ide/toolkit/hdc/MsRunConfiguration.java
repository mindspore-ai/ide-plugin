...
public class MsRunConfiguration extends PythonRunConfiguration {
    ...
    public RunProfileState getState(@NotNull Executor executor, @NotNull ExecutionEnvironment env)
        ...
        HdcPythonScriptCommandLineState pythonScriptCommandLineState = new HdcPythonScriptCommandLineState(this, env);
        Communicator communicator = new Communicator(pythonScriptCommandLineState);
        HdcBrowserWindowManager.getBrowserWindow(this.getProject()).setCommunicator(communicator);
